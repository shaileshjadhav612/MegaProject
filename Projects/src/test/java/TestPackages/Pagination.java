...
//				break;
	...
	public static String getValue(String key) throws IOException
	{
		...
		mpt Mp = new mpt();
		@Test
		public void chckPageIndex() throws Exception
		{
		...
		Thread.sleep(5000);
		String PageIndex = Mp.driver.findElement(By.xpath("//ul[@ng-hide='main_job_tracker_pagination']//span[contains(@class,'ng-binding')]")).getText();
		
		System.out.println("********PageIndexValue: "+PageIndex);
		Validate.isTrue(PageIndex.endsWith("29"), "PageIndexValue is verified True");
